...
def main():
    ...
    st.subheader(':gray[Passos Mágicos]', divider='red')

    st.markdown('''
                A utilização de dados tem se mostrado cada vez mais crucial para organizações que desejam entender e ampliar seu impacto social. Para as ONGs, a adoção de ferramentas avançadas de análise, como machine learning e redes neurais, oferece uma oportunidade de obter insights profundos sobre a efetividade de suas ações. Este trabalho de pós-graduação se dedica a investigar como essas tecnologias podem ser aplicadas na ONG **:red[Passos Mágicos]**, uma organização que trabalha pela inclusão social e pelo fortalecimento comunitário por meio de iniciativas educacionais e culturais. \n
                ''')
    ...
    st.subheader(':gray[Metodologia]', divider='red')
